...
public class ManHinhGameActivity extends AppCompatActivity {
    ...
    private void setCauHoi() {
        ...
        data.add(new CauHoi("Tay phải mày cầm 4 quả lê, 3 quả táo. Tay trái mày cầm được 5 quả sầu riêng thì mày sẽ có gì?","Có một bàn tay rất to","Có quả để ăn","Không có gì hết","Có lê, có táo","Có một bàn tay rất to","Cầm hết được từng đó quả thì chả to tố bố ra ấy chứ","Lần sau nên ghi nhớ",R.drawable.anhmenu01));
        data.add(new CauHoi("Người chồng bị tiểu đường, còn người vợ thì bị bệnh gì ta?","Bệnh chân tay","Bệnh tim","Bệnh sâu răng","Đău dạ dày","Bệnh sâu răng","Múc kẹo nhiều nên bị sâu răng chứ gì :v ","Con gà này hahaaa",R.drawable.anhmenu01));
        ...
        data.add(new CauHoi("Con cua đỏ dài 10cm chạy đua với con cua xanh dài 15 cm. Con nào về đích trước ?","Cua đỏ","Cua xanh","Không quan tâm","2 con về bằng nhau","Cua đỏ là cua chết mà :V ","Mình thích thì mình hỏi thôi","Thôi a chịu chú rồi!!!!",R.drawable.anhmenu01));
        ...
        data.add(new CauHoi("Đố toàn thể anh chị em, đêm tân hôn 2 vợ chồng làm gì?","Động phòng","Chơi game","Đếm tiền","Đi ngủ","Đếm tiền","Hehe, làm gì thì chút làm nha, đến tiền trước đã","Ahihi chơi lại nha ^^",R.drawable.anhmenu01));
        ...
        data.add(new CauHoi("Cây nến đốt càng nhiều càng ngắn, vậy cây gì đốt càng nhiều càng dài?","Cây tre","Không có cây đó","Cây nhang","Cây chuối","Cây tre","Suy nghĩ tại sao mình đúng đi ","Có 1 câu sai hoài k chán hở????",R.drawable.anhmenu01));
        data.add(new CauHoi("Tại sao có phụ nữ mà không có phụ nam?","Câu này đúng quá cho qua","Vì nghe phụ nam không hay","Vì nữ chỉ là phụ","Vì con trai là chính","Vì nữ chỉ là phụ","Theo mình là thế á","Sai rồi thì chịu thôi",R.drawable.anhmenu01));
        data.add(new CauHoi("Tam giác có 3 góc = nhau gọi là gì?","Tam giác cân","Tam giác thường","Tam giác vuông","Tam giác đều","Tâm giác đều","Đã có ai nói với bạn là bạn rất không chưa :v ","Lần sau cố gắng phát huy nha bồ",R.drawable.anhmenu01));
    }
    public void setControl() {
        ...
        coins = (TextView) findViewById(R.id.coinsValue);
    ...
    private void setEvent() {
            ...
            case 0:
                ...
                w = new CountDownTimer(60000, 1000) {
                    ...
                    public void onFinish() {
                        //chuyển thời gian về 0
                        tv.setText("0");
                        //chuyển sang màn hình giải thích
                        Intent intent = new Intent(ManHinhGameActivity.this,GiaiThichSai.class);
                        // put giải thích vào msg
                        intent.putExtra("msg",data.get(a).getGiaiThichSai());
                        //thực thi
                        startActivity(intent);
                        // trừ 10 xu tiền thưởng
                        tienThuong = -10;
                        LuuDuLieuNguoiDung(tienThuong);
                        // hiện số tiền sau khi đã trừ
                        coins.setText(String.valueOf(tongtienmoi));
                        // đóng đếm thời gian
                        w.cancel();
                    }
                }.start();
                break;
                //các case còn lại đều giống case đầu tiên
            case 1:
                CauHoi.setText(data.get(a).getCauHoi());
                imggame.setImageResource(data.get(a).getAnhCauHoi());
                w = new CountDownTimer(60000, 1000) {
        ...
        switch (b){
            case 0:
                // đặt câu trả lời vào các button
                ...
                cautl01.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // so sánh với đáp án trong array
                        if (cautl01.getText() == data.get(a).getDapAn()){
                            // chuyển sang màn hình giải thích đúng nếu đúng
                            Intent intent = new Intent(ManHinhGameActivity.this,GiaiThichDung.class);
                            intent.putExtra("msg",data.get(a).getGiaiThichDung());
                            startActivity(intent);
                            // lại là hàm trừ tiền tham khảo tại case câu hỏi đầu tiên
                            tienThuong = 10;
                            LuuDuLieuNguoiDung(tienThuong);
                            sou.playSound(R.raw.andung01);
                            coins.setText(String.valueOf(tongtienmoi));
                            w.cancel();
                        }else {
                            // chuyển sang màn hình giải thích sai nếu trả lời sai
        ...
        shop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManHinhGameActivity.this,NapTien.class);
                startActivity(intent);
            }
        });
    }
    private void LuuDuLieuNguoiDung(int tienthuong){
        ...
        // lưu trữ tiền dưới key tổng tiền
        tongtiencu = luuTru.getInt("TongTien", 1000);
